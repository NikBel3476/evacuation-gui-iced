...
function animDelayValue() {
	//Gets a user defined frame delay from user input (dom element), displays current value on dom
...
this.gifalizer = function () //function, called from DOM to build gif.
{
	...
	for (var i = 0; i < paintedCanvases.length; i++) {
		...
		imageItems[i].onload = function () {
			...
			scratchCanvasContext.fillRect(
				0,
				0,
				scratchCanvas.width,
				scratchCanvas.height
			);
			scratchCanvasContext.drawImage(
				this,
				0,
				0,
				scratchCanvas.width,
			...
			var imdata = scratchCanvasContext.getImageData(
				0,
				0,
				scratchCanvas.width,
				scratchCanvas.height
			...
			worker.postMessage({
				...
				delay: delay,
				frame_length: paintedCanvases.length - 1,
